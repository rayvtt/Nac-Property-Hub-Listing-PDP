...
const BLOCK = `      <!-- SHARE THIS LISTING (self-contained: scoped styles + inline script) -->
      <section id="nac-share" class="nac-share" data-share-v="4" aria-label="Share this listing">
        ...
        <div class="nac-share-row">
          ...
          <button type="button" class="nac-share-btn" data-net="linkedin" aria-label="Share on LinkedIn" title="LinkedIn"><svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true"><path fill="#ffffff" d="M4.98 3.5A2.5 2.5 0 1 1 0 3.5a2.5 2.5 0 0 1 4.98 0zM.3 8h4.4v13H.3V8zm7.1 0h4.2v1.8h.06c.6-1.1 2-2.2 4.06-2.2 4.35 0 5.15 2.86 5.15 6.58V21h-4.4v-5.9c0-1.4 0-3.2-2-3.2-2 0-2.3 1.5-2.3 3.1V21H7.4V8z"/></svg></button>
...
const BLOCK_CLP = `      <!-- SHARE THIS COUNTRY (self-contained: scoped styles + inline script) -->
      <section id="cl-share" class="cl-share" data-share-clp-v="2" aria-label="Share this country page">
        ...
        <div class="cl-share-row">
          ...
          <button type="button" class="cl-share-btn" data-net="linkedin" aria-label="Share on LinkedIn" title="LinkedIn"><svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true"><path fill="#ffffff" d="M4.98 3.5A2.5 2.5 0 1 1 0 3.5a2.5 2.5 0 0 1 4.98 0zM.3 8h4.4v13H.3V8zm7.1 0h4.2v1.8h.06c.6-1.1 2-2.2 4.06-2.2 4.35 0 5.15 2.86 5.15 6.58V21h-4.4v-5.9c0-1.4 0-3.2-2-3.2-2 0-2.3 1.5-2.3 3.1V21H7.4V8z"/></svg></button>
...
const PDP_OPTS = {
  ...
  versionSentinel: 'data-share-v="4"',
...
const CLP_OPTS = {
  ...
  versionSentinel: 'data-share-clp-v="2"',
