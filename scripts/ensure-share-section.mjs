...
const BLOCK = `      <!-- SHARE THIS LISTING (self-contained: scoped styles + inline script) -->
      <section id="nac-share" class="nac-share" data-share-v="2" aria-label="Share this listing">
        ...
        <style>
          ...
          .nac-share-btn{width:44px;height:44px;display:inline-flex;align-items:center;justify-content:center;border-radius:50%;cursor:pointer;
            border:1px solid rgba(15,26,54,.12);background:#fff;transition:transform .18s ease,background .18s ease,border-color .18s ease,box-shadow .18s ease;padding:0}
          .nac-share-btn svg path{transition:fill .18s ease}
          .nac-share-btn:hover{transform:translateY(-2px);box-shadow:0 4px 12px rgba(15,26,54,.13)}
          .nac-share-btn:active{transform:translateY(0)}
          /* brand colours at rest; the circle fills with the brand colour on hover */
          .nac-share-btn[data-net="facebook"] svg path{fill:#1877F2}
          .nac-share-btn[data-net="facebook"]:hover{background:#1877F2;border-color:#1877F2}
          .nac-share-btn[data-net="facebook"]:hover svg path{fill:#fff}
          .nac-share-btn[data-net="linkedin"] svg path{fill:#0A66C2}
          .nac-share-btn[data-net="linkedin"]:hover{background:#0A66C2;border-color:#0A66C2}
          .nac-share-btn[data-net="linkedin"]:hover svg path{fill:#fff}
          .nac-share-btn[data-net="threads"] svg path{fill:#000000}
          .nac-share-btn[data-net="threads"]:hover{background:#000000;border-color:#000000}
          .nac-share-btn[data-net="threads"]:hover svg path{fill:#fff}
          .nac-share-btn[data-net="instagram"] svg path{fill:#E1306C}
          .nac-share-btn[data-net="instagram"]:hover{background:linear-gradient(45deg,#F58529 0%,#DD2A7B 55%,#8134AF 100%);border-color:transparent}
          .nac-share-btn[data-net="instagram"]:hover svg path{fill:#fff}
          .nac-share-btn[data-net="copy"] svg path{fill:#5b6478}
          .nac-share-btn[data-net="copy"]:hover{background:#0F1A36;border-color:#0F1A36}
          .nac-share-btn[data-net="copy"]:hover svg path{fill:#fff}
          ...
          @media (prefers-color-scheme: dark){
            .nac-share-btn{background:rgba(255,255,255,.95);border-color:rgba(255,255,255,.25)}
          }
        </style>
        <script>
          (function(){
