...
const CLP_SEO = {
  ...
  gr: { title: 'Định cư Hy Lạp: Golden Visa & Bất động sản Hy Lạp | NAC',
        desc: 'Golden Visa Hy Lạp – định cư Hy Lạp qua bất động sản: {n} dự án hàng hiệu tại {cities} — giá, lợi suất, pháp lý và lộ trình thường trú EU từ NAC.' },
  ...
  tr: { title: 'Đầu tư định cư Thổ Nhĩ Kỳ: Bất động sản & Quốc tịch | NAC',
        desc: 'Đầu tư định cư Thổ Nhĩ Kỳ qua bất động sản: {n} dự án hàng hiệu tại {cities} — giá, lợi suất, pháp lý và lộ trình quốc tịch Thổ Nhĩ Kỳ (CBI) từ NAC.' },
