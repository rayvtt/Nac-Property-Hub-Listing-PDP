...
const MARKUP_BLOCK = `
        ...
        <details class="nac-method" id="nac-method">
          <summary class="nac-method-summary" aria-label="Show NAC scoring methodology">
            ...
            <span class="nac-method-summary-meta">
              <span data-vi="">Trọng số · Hiệu chỉnh · Thang xếp hạng</span><span data-en="">Weights · Calibration · Grade scale</span>
            </span>
            <span class="nac-method-summary-chev" aria-hidden="true">＋</span>
          </summary>
          <div class="nac-method-body">
            <p class="nac-method-intro">
              <span data-vi="">Mỗi điểm NAC Composite là sự kết hợp có trọng số của sáu trụ cột đầu tư — cân theo những gì bảo toàn và gia tăng vốn trong suốt kỳ nắm giữ.</span>
              <span data-en="">Every NAC Composite is a weighted blend of six investment pillars — weighted by what protects and compounds capital across a full hold.</span>
            </p>
